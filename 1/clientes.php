...
$xml = "<?xml version='1.0' encoding='ISO8859-1'?>";//cabeçalho do arquivo
       ...
       $ponteiro = fopen('xml/clientes.xml', 'w'); //cria um arquivo com o nome clientes.xml
       fwrite($ponteiro, $xml); // salva conteúdo da variável $xml dentro do arquivo clientes.xml
